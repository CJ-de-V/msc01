...
# Serial syntax: batchrun.py in.lammps
#                in.lammps = LAMMPS input script for setting up situation

# Parallel syntax: mpirun -np 4 python3 batchrun.py in.lammps
...
for k in K:
    ...
    fixsetup = ["fix mythermofile all print 10000 \"$t ${mytemp} ${myepair}\" file thermo_output_N" + str(
        monomercount) + "_k" + str(k) + ".dat screen no",
